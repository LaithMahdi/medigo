...
import 'package:medigo/data/model/onboarding_model.dart';

/// Repository for onboarding-related data
/// Provides access to onboarding content
class OnboardingRepository {
  OnboardingRepository._();

  /// Get all onboarding items
  static List<OnboardingModel> getOnboardingItems() {
    return [
      OnboardingModel(
